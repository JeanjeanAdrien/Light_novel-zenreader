...
export default function Sidebar({ currentUrl, onNavigate }) {
    ...
    return (
        <>
            ...
            {/* Sidebar Panel */}
            <div
                className={`fixed top-0 left-0 h-screen w-80 glass-panel z-[60] transition-transform duration-500 cubic-bezier(0.16, 1, 0.3, 1) flex flex-col shadow-2xl border-r border-white/10 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
            >
                {/* Header */}
